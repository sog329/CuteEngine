...
public class ListActivity extends Activity {
  ...
  protected void onCreate(final Bundle icicle) {
    ...
    mView.addTvCallback(
        ...
        new TvCallback() {
          ...
          public Bitmap buildBmp(String content, int w, int h) {
            Bitmap bmp =
                BmpHelper.getBitmapByText(
                    w,
                    h,
                    content,
                    (int) (h * .7),
                    Color.rgb(255, 255, 255),
                    Color.argb(170, 60, 60, 60),
                    h / 4,
                    h / 15,
                    false);
            return bmp;
    ...
    // Uri.parse("baidupanougc://preview/?jobID=551a1c3e5a06ee251e3ca7ae&userID=80152228")));
  }
  ...
  private void addData() {
    ...
    if (index == 0) {
      //            picUrl =
      // "http://bos.nj.bpc.baidu.com/v1/quanjing-img/55684be0cba709e3763c9b7d_1447728032_scc23pb05t_1451981303.jpg";
    }
    mLstUrl.add(picUrl);
